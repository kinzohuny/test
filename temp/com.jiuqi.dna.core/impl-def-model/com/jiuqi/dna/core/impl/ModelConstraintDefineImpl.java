...
import com.jiuqi.dna.core.def.model.ModelConstraintDeclare;
import com.jiuqi.dna.core.def.model.ModelInvokeStage;
import com.jiuqi.dna.core.exception.NullArgumentException;
import com.jiuqi.dna.core.impl.ModelServiceBase.ModelConstraintChecker;
...
final class ModelConstraintDefineImpl extends InfoDefineImpl implements
	...
	final void internalCheck(ContextImpl<?, ?, ?> context, Object mo,
		...
		if (context == null || mo == null || trigger == null || triggerAO == null || stage == null) {
			throw new NullPointerException();
		}
		if ((this.script == null || !this.script.executeScriptAsChecker(context, mo, this, trigger, triggerAO, value)) && this.checker != null) {
			SpaceNode occorAtSave = this.checker.getService().updateContextSpace(context);
			try {
				this.checker.doCheck(context, mo, this, trigger, triggerAO, value, stage);
			} catch (Throwable e) {
	...
	public final void render(SXElement element) {
		...
		if (this.checker != null) {
			element.setAttribute(xml_attr_checker, this.checker.getClass().getName());
		}
	}
	...
	final void merge(SXElement element, SXMergeHelper helper) {
		...
		if (className != null && className.length() > 0) {
			this.checker = helper.querier.find(ModelConstraintChecker.class, className);
		}
	}
