...
import com.jiuqi.dna.core.def.model.ModelPropAccessDeclare;
...
final class ModelPropAccessDefineImpl implements ModelPropAccessDeclare {
	...
	final boolean isValid() {
		return this.script != null || this.accessor != null || this.field != null;
	}
	...
	final void renderInto(SXElement element, String tag) {
		if (this.field != null || this.script != null && this.script.hasScript() || this.accessor != null) {
			...
			if (this.accessor != null) {
				element.setAttribute(xml_attr_accessor, this.accessor.getClass().getName());
			}
		}
	}
	...
	final void merge(SXElement element, SXMergeHelper helper) {
		...
		if (className != null && className.length() > 0) {
			this.accessor = helper.querier.find(ModelPropertyAccessor.class, className);
		}
	}
}
