...
public interface NSerializeBase_1_1 {
	// 1.1
	public static short SERIALIZE_VERSION = 0x0101;
	...
	static final byte HEAD_WITHTYPEID_TYPE = WithTypeIDObject.TYPE_GUID.headCode;
	static final byte HEAD_WITHTYPEID_CLASS = WithTypeIDObject.CLASS_GUID.headCode;
	static final byte HEAD_WITHTYPEID_SMALLENUM = WithTypeIDObject.SMALLENUM_GUID.headCode;
	static final byte HEAD_WITHTYPEID_LARGEENUM = WithTypeIDObject.LARGEENUM_GUID.headCode;
	static final byte HEAD_WITHTYPEID_STRUCT = WithTypeIDObject.STRUCT_GUID.headCode;
	static final byte HEAD_WITHTYPEID_CUSTOM = WithTypeIDObject.CUSTOM_GUID.headCode;
	static final byte HEAD_WITHTYPEID_OBJECTARRAY = WithTypeIDObject.OBJECTARRAY_GUID.headCode;
	static final byte HEAD_WITHTYPEID_EMPTYOBJECTARRAY = WithTypeIDObject.EMPTY_OBJECTARRAY_GUID.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_TYPE = WithTypeIDObject.TYPE_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_CLASS = WithTypeIDObject.CLASS_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_SMALLENUM = WithTypeIDObject.SMALLENUM_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_LARGEENUM = WithTypeIDObject.LARGEENUM_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_STRUCT = WithTypeIDObject.STRUCT_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_CUSTOM = WithTypeIDObject.CUSTOM_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_OBJECTARRAY = WithTypeIDObject.OBJECTARRAY_POINTER.headCode;
	static final byte HEAD_WITHTYPEIDPOINTER_EMPTYOBJECTARRAY = WithTypeIDObject.EMPTY_OBJECTARRAY_POINTER.headCode;
	static final byte HEAD_WITHCLASSNAME_TYPE = WithClassObject.CLASSNAME_TYPE.headCode;
	static final byte HEAD_WITHCLASSNAME_CLASS = WithClassObject.CLASSNAME_CLASS.headCode;
	static final byte HEAD_WITHCLASSNAME_SMALLENUM = WithClassObject.CLASSNAME_SMALLENUM.headCode;
	static final byte HEAD_WITHCLASSNAME_LARGEENUM = WithClassObject.CLASSNAME_LARGEENUM.headCode;
	static final byte HEAD_WITHCLASSNAME_STRUCT = WithClassObject.CLASSNAME_STRUCT.headCode;
	static final byte HEAD_WITHCLASSNAME_CUSTOM = WithClassObject.CLASSNAME_CUSTOM.headCode;
	static final byte HEAD_WITHCLASSNAME_OBJECTARRAY = WithClassObject.CLASSNAME_OBJECTARRAY.headCode;
	static final byte HEAD_WITHCLASSNAME_EMPTYOBJECTARRAY = WithClassObject.CLASSNAME_EMPTY_OBJECTARRAY.headCode;
	static final byte HEAD_WITHCLASSNAME_ARRAYTYPE = WithClassObject.CLASSNAME_ARRAYTYPE.headCode;
	static final byte HEAD_WITHCLASSNAME_ARRAYCLASS = WithClassObject.CLASSNAME_ARRAYCLASS.headCode;

	static interface ObjectReader {

		Object read(NUnserializer_1_1 unserializer, DataType declareType,
				Object hint);
	...
	static enum MarkObject implements ObjectReader {
		...
		POINTER {
			...
			public final Object read(NUnserializer_1_1 unserializer,
	...
	static enum FixLengthObject implements ObjectReader {
		...
		GUID {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
	...
	static enum WithClassObject implements ObjectReader {

		CLASSNAME_TYPE {

			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readDataTypeByClassName();
			}
		...
		CLASSNAME_CLASS {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readClassByClassName();
			}
		...
		CLASSNAME_SMALLENUM {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readSmallEnumByClassName();
			}
		...
		CLASSNAME_LARGEENUM {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readLargeEnumByClassName();
			}
		...
		CLASSNAME_STRUCT {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readStructByClassName(hint);
			}
		...
		CLASSNAME_CUSTOM {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readCustomByClassName(hint);
			}

		},

		CLASSNAME_OBJECTARRAY {

			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readObjectArrayByClassName(hint);
			}

		},

		CLASSNAME_EMPTY_OBJECTARRAY {

			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readEmptyObjectArrayByClassName(hint);
			}
		...
		CLASSNAME_ARRAYTYPE {
			...
			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readArrayDataTypeByClassName();
			}

		},

		CLASSNAME_ARRAYCLASS {

			public final Object read(final NUnserializer_1_1 unserializer,
					final DataType declareType, final Object hint) {
				return unserializer.readArrayClassByClassName();
			}
		...
		private WithClassObject() {
			this.headCode = (byte) ((ObjectSortCode.WITH_CLASS.ordinal() << 5) | (this.ordinal()));
		}
