...
public final class Obfuscater {
	...
	public static void main(String[] args) {
		final String obf = System.getProperty("obf");
		if (obf != null && obf.length() > 0) {
			System.out.println("obf of " + obf + " is:");
			System.out.println(obfuscate(obf));
		}
		final String unobf = System.getProperty("unobf");
		if (obf != null && obf.length() > 0) {
			System.out.println("unobf of " + obf + " is:");
			System.out.println(unobfuscate(unobf));
		}
	}
}
