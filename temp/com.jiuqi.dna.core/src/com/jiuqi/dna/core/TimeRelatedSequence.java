...
import com.jiuqi.dna.core.impl.TimeRelatedSequenceImpl;
 ...
 * <br>
 * 序列的结构如下：<br>
 * 1. 时间段使用35位[29..63]，按32毫秒为单位计量，略少于35年后会回绕导致冲突<br>
 * 2. 递增序列使用24位[5..28]，共有16M个的序列空间<br>
 * 3. 簇标识使用5位[0..4]，最多表示32个序列簇<br>
 * <br>
 * <br>
 * 限制<br>
