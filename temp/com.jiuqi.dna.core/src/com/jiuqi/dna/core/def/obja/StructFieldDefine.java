...
public interface StructFieldDefine extends FieldDefine {
	...
	public void SETLMergeLongValueNoCheck(DynamicObject entity, long value);

	public void SETLMergeDoubleValueNoCheck(DynamicObject entity, double value);

	public void SETLMergeNullNoCheck(DynamicObject entity);
}
