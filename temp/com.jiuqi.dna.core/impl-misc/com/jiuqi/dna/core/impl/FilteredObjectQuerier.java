...
abstract class FilteredObjectQuerier extends ObjectQuerierImpl {
	...
	public final <TFacade> TFacade find(Class<TFacade> facadeClass, Object key)
			throws UnsupportedOperationException {
		this.checkFacadeClass(facadeClass);
		return this.checkFacade(facadeClass, this.querier.find(facadeClass, key));
	}
	...
	public final <TFacade> TFacade find(Class<TFacade> facadeClass,
		...
		this.checkFacadeClass(facadeClass);
		return this.checkFacade(facadeClass, this.querier.find(facadeClass, key1, key2));
	}
	...
	public final <TFacade> TFacade find(Class<TFacade> facadeClass,
			...
			throws UnsupportedOperationException {
		this.checkFacadeClass(facadeClass);
		return this.checkFacade(facadeClass, this.querier.find(facadeClass, key1, key2, key3));
	}
	...
	public final <TFacade> TFacade find(Class<TFacade> facadeClass,
			...
			throws UnsupportedOperationException {
		this.checkFacadeClass(facadeClass);
		return this.checkFacade(facadeClass, this.querier.find(facadeClass, key1, key2, keys));
	}
}
