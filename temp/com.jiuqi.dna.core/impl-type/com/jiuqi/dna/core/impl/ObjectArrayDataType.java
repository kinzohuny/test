...
class ObjectArrayDataType extends ArrayDataTypeBase {
	...
	static {
		DataTypeUndigester.regUndigester(new DataTypeUndigester(TypeCodeSet.OBJECTS) {
			@Override
	...
	public void writeObjectData(InternalSerializer serializer, Object obj)
		...
		} else if (obj.getClass().isArray() && this.componentJavaClass.isAssignableFrom(obj.getClass().getComponentType())) {
	...
	public Object readObjectData(InternalDeserializer deserializer)
		...
		Object[] objs = (Object[]) Array.newInstance(this.componentJavaClass, len);
