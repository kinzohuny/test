...
<YYINITIAL> {
	...
	"AVG" { return KEYWORD(SQLParser.AVG); }
	"MAX" { return KEYWORD(SQLParser.MAX); }
	"MIN" { return KEYWORD(SQLParser.MIN); }
	"SUM" { return KEYWORD(SQLParser.SUM); }
	"COUNT" { return KEYWORD(SQLParser.COUNT); }
	
	"ROW_NUMBER" { return KEYWORD(SQLParser.ROW_NUMBER); }
	"RANK" { return KEYWORD(SQLParser.RANK); }
	"DENSE_RANK" { return KEYWORD(SQLParser.DENSE_RANK); }
	...
	"ROWS" { return KEYWORD(SQLParser.ROWS); }
	...
	"OVER" { return KEYWORD(SQLParser.OVER); }
	"UNBOUNDED" { return KEYWORD(SQLParser.UNBOUNDED); }
	"PRECEDING" { return KEYWORD(SQLParser.PRECEDING); }
	"FOLLOWING" { return KEYWORD(SQLParser.FOLLOWING); }
	"ROW" { return KEYWORD(SQLParser.ROW); }
