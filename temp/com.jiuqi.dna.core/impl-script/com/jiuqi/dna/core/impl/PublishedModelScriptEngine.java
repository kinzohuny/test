...
final class PublishedModelScriptEngine extends PublishedElement {
	...
	final static StartupStepBase<PublishedModelScriptEngine> create = new StartupStepBase<PublishedModelScriptEngine>(StartupStep.MODEL_SCRIPT_ENGINE_PRI, "实例化模型脚本引擎") {
