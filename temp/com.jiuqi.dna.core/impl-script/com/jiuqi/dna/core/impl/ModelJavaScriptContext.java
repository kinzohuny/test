...
import com.jiuqi.dna.core.def.model.ScriptDefine;
import com.jiuqi.dna.core.exception.NullArgumentException;
import com.jiuqi.dna.core.misc.ObjectBuilder;
import com.jiuqi.dna.core.spi.model.ModelCallScope;
...
final class ModelJavaScriptContext implements
	...
	ModelJavaScriptContext(ModelJavaScriptEngine engine, Context context) {
		...
		this.jsContext = org.mozilla.javascript.ContextFactory.getGlobal().enterContext();
	}
	...
	public final void executeAction(ModelActionDefine actionDefine,
		...
		args[2] = value;
		ModelJavaScriptMO jsmo = new ModelJavaScriptMO(this.context, actionDefine.getOwner(), mo, ModelCallScope.IMPL_ACTION);
	...
	public final void executeChecker(ModelConstraintDefine constraint,
			...
			ModelInvokeDefine trigger, Object triggerAO, Object value) {
		ModelJavaScriptMO jsmo = new ModelJavaScriptMO(this.context, constraint.getOwner(), mo, ModelCallScope.IMPL_CONSTRAINT);
		// context,constraint,$arguments,$value -- 4
		Object[] args = new Object[] { this, constraint, ModelJavaScriptAO.allocJSAO(triggerAO, trigger), value };
		preparedData.call(this.jsContext, jsmo, jsmo, args);
	}
	...
	public final void executeConstructor(ModelConstructorDefine constructor,
		...
		ModelJavaScriptMO jsmo = new ModelJavaScriptMO(this.context, constructor.getOwner(), mo, ModelCallScope.IMPL_CONSTRUCTOR);
		args[0] = this;
		preparedData.call(this.jsContext, jsmo, jsmo, args);
	}
	...
	public final Object executeGetter(ModelPropAccessDefine propAccess,
		...
		ModelJavaScriptMO jsmo = new ModelJavaScriptMO(this.context, property.getOwner(), mo, ModelCallScope.IMPL_GETTER);
		args[0] = this;
	...
	public final void executeSetter(ModelPropAccessDefine propAccess,
		...
		ModelJavaScriptMO jsmo = new ModelJavaScriptMO(this.context, property.getOwner(), mo, ModelCallScope.IMPL_SETTER);
		args[0] = this;
		args[1] = value;
		preparedData.call(this.jsContext, jsmo, jsmo, args);
	}
	...
	public final <TMO> void executeSource(ModelObjSourceDefine sourceDefine,
		...
		args[1] = offset;
		args[2] = count;
		args[3] = new ModelJavaScriptMOs(this.context, sourceDefine.getOwner(), mos, factory);
	...
	private final org.mozilla.javascript.Function compileFunction(
		...
		builder.append("\r\n}");
		return this.jsContext.compileFunction(this.engine.getScope(), builder.toString(), funcName, 0, null);
	}

	public final org.mozilla.javascript.Function prepareAction(
			ModelActionDefine actionDefine) {
		return this.compileFunction("do_", actionDefine.getName(), "context,$arguments,$value", actionDefine, actionDefine.getScript());
	}

	public final org.mozilla.javascript.Function prepareConstraint(
			ModelConstraintDefine constraint) {
		return this.compileFunction("check_", constraint.getName(), "context,constraint,$arguments,$value", null, constraint.getScript());
	}

	public final org.mozilla.javascript.Function prepareConstructor(
			ModelConstructorDefine constructor) {
		return this.compileFunction("new_", constructor.getName(), "context", constructor, constructor.getScript());
	}
	...
	public final org.mozilla.javascript.Function prepareGetter(
		...
		return this.compileFunction("get_", pd.getName(), "context", pd, propAccess.getScript());
	}

	public final org.mozilla.javascript.Function prepareSetter(
			ModelPropAccessDefine propAccess) {
		ModelPropertyDefine pd = propAccess.getPropertyDefine();
		return this.compileFunction("set_", pd.getName(), "context,value", pd, propAccess.getScript());
	}

	public final org.mozilla.javascript.Function prepareSource(
			ModelObjSourceDefine source) {
		return this.compileFunction("fetch_", source.getName(), "context,offset,count,out", source, source.getScript());
	}

	public final org.mozilla.javascript.Function prepareSourceCountOf(
			ModelObjSourceDefine source) {
		return this.compileFunction("countof_", source.getName(), "context", source, source.getMOCountOfScript());
	}

	public final void release() {
		try {
			if (this.jsContext != null && this.jsContext == org.mozilla.javascript.Context.getCurrentContext()) {
	...
	public final void put(String name, org.mozilla.javascript.Scriptable start,
			Object value) {
		throw org.mozilla.javascript.Context.reportRuntimeError("上下文不支持设置该静态属性[" + name + "]");
	}

	public final void put(int index, org.mozilla.javascript.Scriptable start,
			Object value) {
		throw org.mozilla.javascript.Context.reportRuntimeError("上下文不支持设置该静态属性[" + index + "]");
	}
	...
	abstract static class DNAContextMethod implements
		...
		public final Object call(org.mozilla.javascript.Context cx,
			...
			return this.doCall(((ModelJavaScriptContext) thisObj).context, args);
		}
