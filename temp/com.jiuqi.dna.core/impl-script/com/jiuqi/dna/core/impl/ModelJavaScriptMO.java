...
final class ModelJavaScriptMO implements Scriptable {
	...
	public final void put(String name, Scriptable start, Object value) {
		...
		case IMPL_CONSTRAINT:
			throw org.mozilla.javascript.Context.reportRuntimeError("在模型属性获取器中不可以设置该属性值[" + name + "]");
		}
		...
		throw org.mozilla.javascript.Context.reportRuntimeError("模型不支持设置该属性[" + name + "]");
	}

	public final void put(int index, Scriptable start, Object value) {
		throw org.mozilla.javascript.Context.reportRuntimeError("模型不支持设置该属性[" + index + "]");
	}
	...
	final static class JS_ModelAction implements Callable {
		...
		public boolean equals(Object obj) {
			return obj instanceof JS_ModelAction && ((JS_ModelAction) obj).action == this.action;
		}
