...
public class DeclareScriptBroker extends
	...
	final boolean match(Class<?> key1Class, Class<?> key2Class,
		...
		return mask == MASK_DECLARE_SCRIPT && key1Class == String.class && key2Class == DNASqlType.class && key3Class == null;
	}
	...
	final DeclareScriptBroker upperMatchBroker() {
		...
		return (DeclareScriptBroker) space.space.findInvokeeBase(URL.class, String.class, DNASqlType.class, null, MASK_DECLARE_SCRIPT, InvokeeQueryMode.IN_SITE);
	}
}
