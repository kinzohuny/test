...
final class NamedFactoryElementBroker<TFactory extends NamedFactoryElementGather<?, ?>>
	...
	final NamedFactoryElementBroker<TFactory> upperMatchBroker() {
		...
		return (NamedFactoryElementBroker<TFactory>) space.space.findInvokeeBase(this.facotry.getClass(), String.class, null, null, MASK_ELEMENT_META, InvokeeQueryMode.IN_SITE);
	}
	...
	final boolean match(Class<?> key1Class, Class<?> key2Class,
		...
		return mask == MASK_ELEMENT_META && key1Class == String.class && key2Class == null;
	}
}
