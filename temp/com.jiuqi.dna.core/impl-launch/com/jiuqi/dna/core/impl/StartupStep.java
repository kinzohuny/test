...
public interface StartupStep<TTarget extends StartupEntry> {
	 ...
	 * 日志服务准备，要在服务启动之前启动。
	 */
	final static int LOGMGR_PREPARE_PRI = PublishedService.service_init.getPriority() - 0x20;

	/**
	 * 日志服务就绪。
	 */
	final static int LOGMGR_READY_PRI = PublishedService.service_init.getPriority() + 0x20;
