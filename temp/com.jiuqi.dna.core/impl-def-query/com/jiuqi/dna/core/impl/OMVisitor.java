 ...
 * 
 */
public interface OMVisitor<TContext> {
	...
	void visitAnalyticFunctionExpr(AnalyticFunctionExpr expr, TContext context);
	...
	void visitStoredProcedure(StoredProcedureDefineImpl procedure,
			TContext context);
}