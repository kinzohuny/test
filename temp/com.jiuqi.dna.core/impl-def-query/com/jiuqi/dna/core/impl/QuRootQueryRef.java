 ...
 * 
 */
public final class QuRootQueryRef extends
		QuRootRelationRefImpl<DerivedQueryImpl> implements QuQueryRef {
	...
	public final SelectColumnRefImpl expOf(String relationColumnName) {
		SelectColumnImpl<?, ?> column = this.target.columns.find(relationColumnName);
		if (column == null) {
