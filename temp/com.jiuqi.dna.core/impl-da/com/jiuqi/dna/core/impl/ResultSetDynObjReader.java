 ...
 * 
 */
public class ResultSetDynObjReader extends ResultSetReader {

	public ResultSetDynObjReader(ResultSet resultSet) {
		super(resultSet);
	}
	...
	public final Object inDate(Object userData) throws SQLException {
		...
		if (userData != read_only_return) {
			if (value == null) {
				...
				this.targetField.setFieldValueAsDateNoCheck(this.obj, value.getTime());
			}
		}
		return value;
	}
	...
	public final Object inObject(Object userData, ObjectDataType type)
			throws Throwable {
		Object value = this.resultSet.getObject(this.columnIndex);
		if (userData != read_only_return) {
			this.targetField.setFieldValueAsObjectNoCheck(this.obj, value);
		}
		return value;
	}
	...
	public final void readResult(DynObj obj, StructDefineImpl struct) {
		this.columnIndex = 1;
		this.obj = obj;
	...
	public final void readRecord(DynObj record, QueryStatementBase query) {
		this.columnIndex = 1;
		this.obj = record;
	...
	public static final void readRecords(QueryStatementImpl query,
