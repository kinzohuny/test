...
public class HanaSpCallSql extends SpCallSql {

	public HanaSpCallSql(HanaMetadata dbMetadata,
	...
	@Override
	public SpExecutor newExecutor(DBAdapterImpl adapter, ActiveChangable notify) {
