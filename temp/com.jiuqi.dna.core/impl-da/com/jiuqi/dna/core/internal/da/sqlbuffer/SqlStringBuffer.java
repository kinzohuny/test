...
public class SqlStringBuffer implements Appendable {
	...
	public Appendable append(CharSequence csq, int start, int end)
			throws IOException {
		if (csq instanceof String) {
			this.append((String) csq, start, end);
		}
		return this;
	}
	...
	public void writeTo(char[] buffer, int offset) {
		...
		if (this.offset > 0) {
			System.arraycopy(this.list.get(this.validCount - 1), 0, buffer, offset, this.offset);
		}
	}
