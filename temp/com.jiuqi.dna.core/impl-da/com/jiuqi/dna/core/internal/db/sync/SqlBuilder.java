...
public final class SqlBuilder implements CharSequence, Appendable {
	...
	private static final int NEED_PUNCTUATON = NEED_COMMA | NEED_PERIOD | NEED_SEMICOLON;
	...
	public final SqlBuilder appendType(DataType type) {
		this.resovleNeeds();
		this.dbMetadata.format(this, type);
		return this;
	}
	...
	public final SqlBuilder appendAlter() {
		this.need |= NEED_SPACE;
		this.append("alter");
		this.need |= NEED_SPACE;
		return this;
	...
	public final SqlBuilder appendColumn() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendConstraint() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendCreate() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendGlobal() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
		this.str.append("global");
		this.need |= NEED_SPACE;
		return this;
	}
	
	public final SqlBuilder appendTemporary() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
		this.str.append("temporary");
		this.need |= NEED_SPACE;
		return this;
	}
	
	public final SqlBuilder appendCommit() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
		this.str.append("commit");
		this.need |= NEED_SPACE;
		return this;
	}
	
	public final SqlBuilder appendRows() {//新增主要用于创建Oracle全局临时表
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendDefault() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendDelete() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendDrop() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendIndex() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendNot() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendNull() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendOn() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendTable() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public final SqlBuilder appendPrimaryKey() {
		this.need |= NEED_SPACE;
		this.resovleNeeds();
	...
	public SqlBuilder(DbMetadata databaseStub) {
		if (databaseStub == null) {
			throw new NullPointerException();
		}
		this.dbMetadata = databaseStub;
		this.need = BOF;
	}

	public final SqlBuilder appendId(String name) {
		this.dbMetadata.quoteId(this, name);
		return this;
	}
