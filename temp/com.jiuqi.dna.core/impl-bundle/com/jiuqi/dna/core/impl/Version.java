...
final class Version implements Comparable<Version> {
	...
	public final int hashCode() {
		return ((this.v1 * 31 + this.v2) * 31 + this.v3) * 31 + this.qualifier == null ? 0 : this.qualifier.hashCode();
	}
	...
	public final boolean equals(Object obj) {
		...
		if (obj instanceof Version) {
			...
			return v.v1 == this.v1 && v.v2 == this.v2 && v.v3 == this.v3 && v.qualifier != null && v.qualifier.equals(this.qualifier);
		}
		return false;
	}
