...
final class ByteBufferSerializer implements DataSerializer {
	...
	private void nextByteBuffer() {
		...
		NetConnection.putDataPacketHeaderData(this.working, this.packetCode, 0, this.requestId, 0/* 空数据包 */);
	}
	...
	public final void close() {
		if (this.working != null && this.working.position() > NetConnection.DATAGRAM_HEADER_LENGTH) {
			// 缓存中仍有未发送的数据。
			this.submitCurrentBuffer();
