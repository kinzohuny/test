...
final class SOSerializer implements StructuredObjectSerializer {
	...
	private void writeNewObject(Object obj) throws IOException,
		...
		if (obj instanceof Class) {
			...
			final DataType objDataType = DataTypeBase.dataTypeOfJavaObjForOldSerial(obj);
			if (objDataType instanceof StructDefineImpl) {
				...
				this.writeSpecialObject((ObjectDataTypeInternal) objDataType, obj);
			} else {
				throw new StructDefineNotFoundException(obj.getClass().getName());
			}
		}
	}
