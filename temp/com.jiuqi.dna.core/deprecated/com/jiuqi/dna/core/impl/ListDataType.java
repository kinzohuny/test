...
abstract class ListDataType<TList extends List<?>> extends RefDataType {
	...
	static {
		DataTypeUndigester.regUndigester(new DataTypeUndigester(TypeCodeSet.LIST) {
			@SuppressWarnings("unchecked")
			@Override
	...
	@SuppressWarnings("unchecked")
	static final ListDataType<ArrayList> arrayListType = new ListDataType<ArrayList>(ArrayList.class) {
		@Override
	...
	@SuppressWarnings("unchecked")
	static final ListDataType<DnaArrayList> dnaArrayListType = new ListDataType<DnaArrayList>(DnaArrayList.class) {
		@Override
	...
	@SuppressWarnings("unchecked")
	static final ListDataType<SafeItrList> safeItrListType = new ListDataType<SafeItrList>(SafeItrList.class) {
		@Override
