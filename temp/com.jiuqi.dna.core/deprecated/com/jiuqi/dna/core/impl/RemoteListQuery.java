...
abstract class RemoteListQuery extends RemoteQueryBase<RemoteListQueryStubImpl> {
	...
	static RemoteListQuery buildListQuery(Class<?> resultClass, Object key1,
		...
		return new MoreKeyRemoteListQuery(resultClass, key1, key2, key3, otherKeys);
	}
	...
	private static final class OneKeyRemoteListQuery extends RemoteListQuery {
		...
		@Override
		final List execQuery(ContextImpl<?, ?, ?> context) {
			return context.getList(this.queryBy.resultClass, this.queryBy.getKey1());
		}
	}
	...
	private static final class TwoKeyRemoteListQuery extends RemoteListQuery {
		...
		@Override
		final List execQuery(ContextImpl<?, ?, ?> context) {
			return context.getList(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2());
		}
	}
	...
	private static final class ThreeKeyRemoteListQuery extends RemoteListQuery {
		...
		@Override
		final List execQuery(ContextImpl<?, ?, ?> context) {
			return context.getList(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2(), this.queryBy.getKey3());
		}
	}
	...
	private static final class MoreKeyRemoteListQuery extends RemoteListQuery {
		...
		@Override
		final List execQuery(ContextImpl<?, ?, ?> context) {
			return context.getList(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2(), this.queryBy.getKey3(), this.queryBy.getOtherKeys());
		}
	}
}
