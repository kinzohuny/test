...
final class StructSummary {
	...
	StructSummary(StructDefineImpl structDefine) {
		this(structDefine.name, structDefine.getSerialVUID(), structDefine.isDynObj);
	...
	boolean equalNameAndVUIDs(StructSummary sum) {
		...
		return this.defineName.equals(sum.defineName) && Arrays.equals(this.serialVUID, sum.serialVUID);
	}
}
