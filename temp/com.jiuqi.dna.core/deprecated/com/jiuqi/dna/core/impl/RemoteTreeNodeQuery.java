...
abstract class RemoteTreeNodeQuery extends
	...
	static RemoteTreeNodeQuery buildTreeNodeQuery(Class<?> resultClass,
		...
		return new MoreKeyRemoteTreeNodeQuery(resultClass, key1, key2, key3, otherKeys);
	}
	...
	private static final class OneKeyRemoteTreeNodeQuery extends
		...
		@Override
		final TreeNode execQuery(ContextImpl<?, ?, ?> context) {
			return context.getTreeNode(this.queryBy.resultClass, this.queryBy.getKey1());
		}
	}
	...
	private static final class TwoKeyRemoteTreeNodeQuery extends
		...
		@Override
		final TreeNode execQuery(ContextImpl<?, ?, ?> context) {
			return context.getTreeNode(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2());
		}
	}
	...
	private static final class ThreeKeyRemoteTreeNodeQuery extends
		...
		@Override
		final TreeNode execQuery(ContextImpl<?, ?, ?> context) {
			return context.getTreeNode(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2(), this.queryBy.getKey3());
		}
	}
	...
	private static final class MoreKeyRemoteTreeNodeQuery extends
		...
		@Override
		final TreeNode execQuery(ContextImpl<?, ?, ?> context) {
			return context.getTreeNode(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2(), this.queryBy.getKey3(), this.queryBy.getOtherKeys());
		}
	}
}
