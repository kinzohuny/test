 ...
 */
@Deprecated
final class OldRemoteServiceInvokerImpl implements ServiceInvokerExtend {
	...
	OldRemoteServiceInvokerImpl(Context context,
	...
	private <TResult> RemoteOverlappedResult<TResult, None, None, None> internalAsyncGet(
		...
		return (new RemoteOverlappedResult<TResult, None, None, None>(query, queryStub));
	}
	...
	private <TResult, TKey> RemoteOverlappedResult<TResult, TKey, None, None> internalAsyncGet(
		...
		RemoteQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResult<TResult, TKey, None, None>(query, queryStub));
	}
	...
	private <TResult, TKey1, TKey2> RemoteOverlappedResult<TResult, TKey1, TKey2, None> internalAsyncGet(
		...
		RemoteQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResult<TResult, TKey1, TKey2, None>(query, queryStub));
	}
	...
	private <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResult<TResult, TKey1, TKey2, TKey3> internalAsyncGet(
		...
		RemoteQuery query = RemoteQuery.buildQuery(resultClass, key, key2, key3);
		RemoteQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResult<TResult, TKey1, TKey2, TKey3>(query, queryStub));
	}

	private <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResult<TResult, TKey1, TKey2, TKey3> internalAsyncGet(
			Class<TResult> resultClass, TKey1 key, TKey2 key2, TKey3 key3,
			Object[] otherKeys) {
		RemoteQuery query = RemoteQuery.buildQuery(resultClass, key, key2, key3, otherKeys);
		RemoteQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResult<TResult, TKey1, TKey2, TKey3>(query, queryStub));
	}
	...
	public <TResult, TKey> RemoteOverlappedResult<TResult, TKey, None, None> asyncGet(
			Class<TResult> resultClass, TKey key) {
		this.checkArgsNotNull(resultClass, key);
		return this.internalAsyncGet(resultClass, key);
	}

	public <TResult, TKey1, TKey2> RemoteOverlappedResult<TResult, TKey1, TKey2, None> asyncGet(
			Class<TResult> resultClass, TKey1 key, TKey2 key2) {
		this.checkArgsNotNull(resultClass, key, key2);
		return this.internalAsyncGet(resultClass, key, key2);
	}

	public <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResult<TResult, TKey1, TKey2, TKey3> asyncGet(
			Class<TResult> resultClass, TKey1 key, TKey2 key2, TKey3 key3) {
	...
	private <TResult> RemoteOverlappedResultList<TResult, None, None, None> internalAsyncGetList(
		...
		RemoteListQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResultList<TResult, None, None, None>(query, queryStub));
	}
	...
	private <TResult, TKey1> RemoteOverlappedResultList<TResult, TKey1, None, None> internalAsyncGetList(
		...
		RemoteListQuery query = RemoteListQuery.buildListQuery(resultClass, key1);
		RemoteListQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResultList<TResult, TKey1, None, None>(query, queryStub));
	}

	private <TResult, TKey1, TKey2> RemoteOverlappedResultList<TResult, TKey1, TKey2, None> internalAsyncGetList(
			Class<TResult> resultClass, TKey1 key1, TKey2 key2) {
		RemoteListQuery query = RemoteListQuery.buildListQuery(resultClass, key1, key2);
		RemoteListQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResultList<TResult, TKey1, TKey2, None>(query, queryStub));
	}

	private <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResultList<TResult, TKey1, TKey2, TKey3> internalAsyncGetList(
			Class<TResult> resultClass, TKey1 key1, TKey2 key2, TKey3 key3) {
		RemoteListQuery query = RemoteListQuery.buildListQuery(resultClass, key1, key2, key3);
		RemoteListQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResultList<TResult, TKey1, TKey2, TKey3>(query, queryStub));
	}

	private <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResultList<TResult, TKey1, TKey2, TKey3> internalAsyncGetList(
			Class<TResult> resultClass, TKey1 key1, TKey2 key2, TKey3 key3,
			Object[] otherKeys) {
		RemoteListQuery query = RemoteListQuery.buildListQuery(resultClass, key1, key2, key3, otherKeys);
		RemoteListQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedResultList<TResult, TKey1, TKey2, TKey3>(query, queryStub));
	}

	public <TResult> RemoteOverlappedResultList<TResult, None, None, None> asyncGetList(
			Class<TResult> resultClass) {
		this.checkArgsNotNull(resultClass);
		return this.internalAsyncGetList(resultClass);
	}

	public <TResult, TKey1> RemoteOverlappedResultList<TResult, TKey1, None, None> asyncGetList(
			Class<TResult> resultClass, TKey1 key1) {
		this.checkArgsNotNull(resultClass, key1);
		return this.internalAsyncGetList(resultClass, key1);
	}

	public <TResult, TKey1, TKey2> RemoteOverlappedResultList<TResult, TKey1, TKey2, None> asyncGetList(
			Class<TResult> resultClass, TKey1 key1, TKey2 key2) {
		this.checkArgsNotNull(resultClass, key1, key2);
		return this.internalAsyncGetList(resultClass, key1, key2);
	}

	public <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResultList<TResult, TKey1, TKey2, TKey3> asyncGetList(
			Class<TResult> resultClass, TKey1 key1, TKey2 key2, TKey3 key3) {
	...
	public <TResult, TKey1, TKey2, TKey3> RemoteOverlappedResultList<TResult, TKey1, TKey2, TKey3> asyncGetList(
		...
		return this.internalAsyncGetList(resultClass, key1, key2, key3, otherKeys);
	}
	...
	private <TFacade> RemoteOverlappedTreeNodeResult<TFacade, None, None, None> internalAsyncGetTreeNode(
		...
		RemoteTreeNodeQuery query = RemoteTreeNodeQuery.buildTreeNodeQuery(facadeClass);
		RemoteTreeNodeQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedTreeNodeResult<TFacade, None, None, None>(query, queryStub));
	}
	...
	private <TFacade, TKey> RemoteOverlappedTreeNodeResult<TFacade, TKey, None, None> internalAsyncGetTreeNode(
		...
		RemoteTreeNodeQuery query = RemoteTreeNodeQuery.buildTreeNodeQuery(facadeClass, key);
		RemoteTreeNodeQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedTreeNodeResult<TFacade, TKey, None, None>(query, queryStub));
	}
	...
	private <TFacade, TKey1, TKey2> RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, None> internalAsyncGetTreeNode(
		...
		RemoteTreeNodeQuery query = RemoteTreeNodeQuery.buildTreeNodeQuery(facadeClass, key1, key2);
		RemoteTreeNodeQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, None>(query, queryStub));
	}
	...
	private <TFacade, TKey1, TKey2, TKey3> RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, TKey3> internalAsyncGetTreeNode(
		...
		RemoteTreeNodeQuery query = RemoteTreeNodeQuery.buildTreeNodeQuery(facadeClass, key1, key2, key3);
		RemoteTreeNodeQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, TKey3>(query, queryStub));
	}

	private <TFacade, TKey1, TKey2, TKey3> RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, TKey3> internalAsyncGetTreeNode(
			Class<TFacade> facadeClass, TKey1 key1, TKey2 key2, TKey3 key3,
			Object[] otherKeys) {
		RemoteTreeNodeQuery query = RemoteTreeNodeQuery.buildTreeNodeQuery(facadeClass, key1, key2, key3, otherKeys);
		RemoteTreeNodeQueryStubImpl queryStub = this.getConnection().postRequest(query);
		return (new RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, TKey3>(query, queryStub));
	}

	public <TFacade> RemoteOverlappedTreeNodeResult<TFacade, ?, ?, ?> asyncGetTreeNode(
			Class<TFacade> facadeClass) {
		this.checkArgsNotNull(facadeClass);
		return this.internalAsyncGetTreeNode(facadeClass);
	}

	public <TFacade, TKey> RemoteOverlappedTreeNodeResult<TFacade, TKey, None, None> asyncGetTreeNode(
			Class<TFacade> facadeClass, TKey key) {
		this.checkArgsNotNull(facadeClass, key);
		return this.internalAsyncGetTreeNode(facadeClass, key);
	}

	public <TFacade, TKey1, TKey2> RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, ?> asyncGetTreeNode(
			Class<TFacade> facadeClass, TKey1 key1, TKey2 key2) {
		this.checkArgsNotNull(facadeClass, key1, key2);
		return this.internalAsyncGetTreeNode(facadeClass, key1, key2);
	}

	public <TFacade, TKey1, TKey2, TKey3> RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, TKey3> asyncGetTreeNode(
			Class<TFacade> facadeClass, TKey1 key1, TKey2 key2, TKey3 key3) {
	...
	public <TFacade, TKey1, TKey2, TKey3> RemoteOverlappedTreeNodeResult<TFacade, TKey1, TKey2, TKey3> asyncGetTreeNode(
		...
		return this.internalAsyncGetTreeNode(facadeClass, key1, key2, key3, otherKeys);
	}
	...
	private RemoteAsyncEvent asyncFire(Event event, boolean wait) {
		...
		RemoteEventStubImpl stub = this.getConnection().postRequest(remoteEvent);
	...
	public void handle(SimpleTask task) throws DeadLockException {
		...
		RemoteAsyncTask<SimpleTask, None> asyncTask = this.internalAsyncHandle(task);
		asyncTask.waitToFinish();
		if (asyncTask.noException()) {
			// XXX copy values from returnedTask to task.
			OBJAContext.clone(asyncTask.getTask(), task, null);
		} else {
	...
	public <TMethod extends Enum<TMethod>> void handle(Task<TMethod> task,
		...
		RemoteAsyncTask<Task<TMethod>, TMethod> asyncTask = this.internalAsyncHandle(task, method);
		asyncTask.waitToFinish();
		if (asyncTask.noException()) {
			// XXX copy values from returnedTask to task.
			OBJAContext.clone(asyncTask.getTask(), task, null);
	...
	private static <TFacade> TreeNode<TFacade> waitGetTreeNode(
		...
		if (treeNodeResult.noException()) {
			return treeNodeResult.getResultTreeNode();
		} else {
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
		...
		this.checkArgsNotNull(facadeClass, key1, key2, key3, otherKeys);
		return waitGetTreeNode(this.internalAsyncGetTreeNode(facadeClass, key1, key2, key3, otherKeys));
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			throws UnsupportedOperationException {
		this.checkArgsNotNull(facadeClass, key1, key2, key3);
		return waitGetTreeNode(this.internalAsyncGetTreeNode(facadeClass, key1, key2, key3));
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			Object key1, Object key2) throws UnsupportedOperationException {
		this.checkArgsNotNull(facadeClass, key1, key2);
		return waitGetTreeNode(this.internalAsyncGetTreeNode(facadeClass, key1, key2));
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2, key3, otherKeys), null, sortComparator);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			Comparator<? super TFacade> sortComparator, Object key1,
			Object key2, Object key3) throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2, key3), null, sortComparator);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			Comparator<? super TFacade> sortComparator, Object key1, Object key2)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2), null, sortComparator);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			Comparator<? super TFacade> sortComparator, Object key)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key), null, sortComparator);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			Comparator<? super TFacade> sortComparator)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass), null, sortComparator);
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2, key3, otherKeys), filter, null);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			TreeNodeFilter<? super TFacade> filter, Object key1, Object key2,
			Object key3) throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2, key3), filter, null);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			TreeNodeFilter<? super TFacade> filter, Object key1, Object key2)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2), filter, null);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			TreeNodeFilter<? super TFacade> filter, Object key)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key), filter, null);
	}

	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			TreeNodeFilter<? super TFacade> filter)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass), filter, null);
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			Object key2, Object key3, Object... otherKeys)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2, key3, otherKeys), filter, sortComparator);
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			Comparator<? super TFacade> sortComparator, Object key1,
			Object key2, Object key3) throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2, key3), filter, sortComparator);
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			Comparator<? super TFacade> sortComparator, Object key1, Object key2)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key1, key2), filter, sortComparator);
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			Comparator<? super TFacade> sortComparator, Object key)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass, key), filter, sortComparator);
	}
	...
	public <TFacade> TreeNode<TFacade> getTreeNode(Class<TFacade> facadeClass,
			...
			Comparator<? super TFacade> sortComparator)
			throws UnsupportedOperationException {
		return filterAndSortRecursively(this.getTreeNode(facadeClass), filter, sortComparator);
	}
	...
	public <TFacade> TFacade find(Class<TFacade> facadeClass, Object key1,
		...
		return waitFind(this.internalAsyncGet(facadeClass, key1, key2, key3, keys));
	}
	...
	public <TFacade> TFacade get(Class<TFacade> facadeClass, Object key1,
		...
		this.checkArgsNotNull(facadeClass, key1, key2, key3, keys);
		return waitGet(this.internalAsyncGet(facadeClass, key1, key2, key3, keys));
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
		...
		return filter(this.getList(facadeClass, key1, key2, key3, otherKeys), filter);
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
		...
		return sort(filter(this.getList(facadeClass, key1, key2, key3, otherKeys), filter), sortComparator);
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
		...
		return sort(filter(this.getList(facadeClass, key1, key2, key3), filter), sortComparator);
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
		...
		return sort(filter(this.getList(facadeClass, key1, key2), filter), sortComparator);
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
		...
		return sort(filter(this.getList(facadeClass, key), filter), sortComparator);
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
		...
		return sort(this.getList(facadeClass, key1, key2, key3, otherKeys), sortComparator);
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
			Object key1, Object key2, Object key3, Object... otherKeys) {
		this.checkArgsNotNull(facadeClass, key1, key2, key3, otherKeys);
		return waitGetList(this.internalAsyncGetList(facadeClass, key1, key2, key3, otherKeys));
	}
	...
	public <TFacade> List<TFacade> getList(Class<TFacade> facadeClass,
			...
			throws UnsupportedOperationException {
		this.checkArgsNotNull(facadeClass, key1, key2, key3);
		return waitGetList(this.internalAsyncGetList(facadeClass, key1, key2, key3));
	}
