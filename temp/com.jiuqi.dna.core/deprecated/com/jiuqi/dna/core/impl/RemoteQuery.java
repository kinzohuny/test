...
abstract class RemoteQuery extends RemoteQueryBase<RemoteQueryStubImpl> {
	...
	private static final class OneKeyRemoteQuery extends RemoteQuery {
		...
		@Override
		final Object execQuery(ContextImpl<?, ?, ?> context) {
			return context.find(this.queryBy.resultClass, this.queryBy.getKey1());
		}
	}
	...
	private static final class TwoKeyRemoteQuery extends RemoteQuery {
		...
		@Override
		final Object execQuery(ContextImpl<?, ?, ?> context) {
			return context.find(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2());
		}
	}
	...
	private static final class ThreeKeyRemoteQuery extends RemoteQuery {
		...
		@Override
		final Object execQuery(ContextImpl<?, ?, ?> context) {
			return context.find(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2(), this.queryBy.getKey3());
		}
	}
	...
	private static final class MoreKeyRemoteQuery extends RemoteQuery {
		...
		@Override
		final Object execQuery(ContextImpl<?, ?, ?> context) {
			return context.find(this.queryBy.resultClass, this.queryBy.getKey1(), this.queryBy.getKey2(), this.queryBy.getKey3(), this.queryBy.getOtherKeys());
		}
	}
}
