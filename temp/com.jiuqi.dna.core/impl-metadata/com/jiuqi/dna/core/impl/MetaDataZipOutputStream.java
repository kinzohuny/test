...
public final class MetaDataZipOutputStream extends ZipOutputStream {
	...
	public static void main(String[] args) throws IOException {
		...
		MetaDataZipOutputStream moStream = new MetaDataZipOutputStream(outStream);
		try {
		...
		MetaDataZipInputStream miStream = new MetaDataZipInputStream(outStream.toByteArray());
		try {
