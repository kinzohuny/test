...
public class ManifestElement {
	...
	private static final String MANIFEST_INVALID_SPACE = "The manifest line \"{0}\" has an invalid leading space '' '' character.";
	private static final String MANIFEST_INVALID_LINE_NOCOLON = "The manifest line \"{0}\" is invalid; it has no colon '':'' character after the header key.";
	private static final String MANIFEST_INVALID_HEADER_EXCEPTION = "Invalid manifest header {0}: \"{1}\"";
	...
	public static ManifestElement[] parseHeader(String header, String value) throws BundleException {
		...
		parseloop: while (true) {
			...
			if (next == null)
				throw new BundleException(NLS.bind(MANIFEST_INVALID_HEADER_EXCEPTION, header, value), BundleException.MANIFEST_ERROR);
		...
		try {
			...
			while (true) {
				...
				if (line.charAt(0) == ' ') /* continuation */
				{
					...
					{
						throw new BundleException(NLS.bind(MANIFEST_INVALID_SPACE, line), BundleException.MANIFEST_ERROR);
					}
				...
				if (colon == -1) /* no colon */
				{
					throw new BundleException(NLS.bind(MANIFEST_INVALID_LINE_NOCOLON, line), BundleException.MANIFEST_ERROR);
				}
