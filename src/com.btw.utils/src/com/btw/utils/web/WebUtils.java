...
public abstract class WebUtils {
	...
	private static String _doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout, Map<String, String> headerMap) throws IOException {
		...
		try {
			try {
				...
				logCommError(e, null, url, new String(content));
				throw e;
			}
			try {
				...
				logCommError(e, conn, null, new String(content));
				throw e;
			}
		} finally {
			if (out != null) {
	...
	public static void logCommError(Exception e, HttpURLConnection conn, String url, String content){
		...
		StringBuilder sb = new StringBuilder(e.getMessage() + "".replaceAll("\r\n", " "));
		sb.append("^^^^^^URL:");
