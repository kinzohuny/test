...
public class ManagerDao {
	...
	public int verify(String name, String password) throws SQLException, ClassNotFoundException{
	...
	public int updateLoginTime(String name, Timestamp time, String ip) throws SQLException, ClassNotFoundException{
